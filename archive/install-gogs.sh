...
# Gogs
cp sample-marathon-gogs.json $DEPLOYMENT_NAME-gogs.json
...
# Drone
cp sample-marathon-drone-gogs.json $DEPLOYMENT_NAME-drone.json
...
# Registry
cp sample-marathon-registry.json $DEPLOYMENT_NAME-registry.json
